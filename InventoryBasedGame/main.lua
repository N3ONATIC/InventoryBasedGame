...
function love.load()
    ...
    NewThread = love.thread.newThread(threadCode)
end
...
function love.draw()
    ...
    if ItemOn ~= -1 then
        if IsDescriptionShown == false then
            ...
            if IsAnimatingDescription == true then
                love.graphics.draw(descriptionBackgroundImage, love.mouse.getX() + 20, love.mouse.getY() + 100, 0, CurrentIndex, 0.5)
            else
            ...
            love.graphics.draw(descriptionBackgroundImage, love.mouse.getX() + 20, love.mouse.getY() + 100, 0, 0.1, 0.1)
        end
    else
    ...
    love.graphics.print(tostring(ItemOn) .. " " .. tostring(IsDescriptionShown) .. " " ..  tostring(CurrentIndex) .. " " .. tostring(NewThread:isRunning()), 0, 15)
end
